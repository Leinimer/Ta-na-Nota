    ...
    <div className="select-none group/item relative">
      <div
        ...
        className={`
          ...
          ${
            isActive
              ? 'bg-[#f4dfcb] dark:bg-[#3c3328] font-medium text-[#68594d] dark:text-[#d7c3b4] border-l-2 border-[#68594d] dark:border-[#d7c3b4]'
              : 'text-[#1b1c19] dark:text-[#f2f1ec] hover:bg-[#eae8e3] dark:hover:bg-[#2c2a26]'
          }
          ${isDragOver ? 'ring-2 ring-[#68594d] bg-[#f4dfcb]/60' : ''}
        `}
      >
        ...
        {isFolder ? (
          <button
            ...
            className="w-4 h-4 flex items-center justify-center text-[#7f756e] hover:text-[#1b1c19] p-0.5"
          >
        ...
        {/* Icon */}
        <span className="text-[#68594d] dark:text-[#d7c3b4] shrink-0">
          {isFolder ? (
            isExpanded ? (
              <FolderOpen className="w-4 h-4 text-[#796758]" />
            ) : (
              <Folder className="w-4 h-4 text-[#796758]" />
            )
          ) : (
            <FileText className="w-4 h-4 text-[#7f756e]" />
          )}
        </span>
        ...
        {isEditing ? (
          <input
            ...
            className="flex-1 bg-[#ffffff] dark:bg-[#191816] px-1.5 py-0.5 rounded border border-[#68594d] text-xs outline-none"
          />
        ) : (
          <span
            onDoubleClick={(e) => {
        ...
        <div className="opacity-0 group-hover/item:opacity-100 transition-opacity flex items-center gap-0.5">
          {isFolder && (
            <button
              ...
              className="p-1 text-[#7f756e] hover:text-[#1b1c19] hover:bg-[#d1c4bc]/40 rounded"
            >
        ...
        {showMenu && (
          <>
            ...
            <div
              className="absolute right-2 top-full mt-1 z-40 w-44 bg-[#ffffff] dark:bg-[#23221e] border border-[#d1c4bc] dark:border-[#44403a] rounded-lg shadow-lg py-1 text-xs text-[#1b1c19] dark:text-[#f2f1ec] animate-in fade-in zoom-in-95 duration-100"
              onClick={(e) => e.stopPropagation()}
            >
              {isFolder ? (
                <>
                  ...
                  >
                    <Plus className="w-3.5 h-3.5 text-[#68594d]" /> Nova Nota
                  </button>
                  <button
                    onClick={() => {
                      setShowMenu(false);
                    ...
                    className="w-full text-left px-3 py-1.5 hover:bg-[#f5f3ee] dark:hover:bg-[#2c2a26] flex items-center gap-2"
                  >
                    <FolderPlus className="w-3.5 h-3.5 text-[#68594d]" /> Nova Subpasta
                  </button>
                </>
              ) : (
                <>
                  ...
                  <button
                    ...
                    className="w-full text-left px-3 py-1.5 hover:bg-[#f5f3ee] dark:hover:bg-[#2c2a26] flex items-center gap-2"
                  >
                    <Copy className="w-3.5 h-3.5" /> Duplicar Nota
                  </button>
                  <button
                    onClick={() => {
                      setShowMenu(false);
              ...
              <div className="h-px bg-[#eae8e3] dark:bg-[#36342f] my-1" />
      ...
      {isFolder && isExpanded && (!node.children || node.children.length === 0) && (
        <div
          ...
          className="py-1 text-[11px] text-[#7f756e] italic"
        >
          Pasta vazia
        </div>
      )}
